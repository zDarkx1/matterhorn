        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @auth
                    <a href="{{ route('profile') }}" class="text-sm text-gray-600 hover:text-brand-orange transition">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-96 lg:flex-shrink-0">
                ...
                <div id="summaryCard" class="bg-white border border-gray-200 p-6 sticky top-24">
                    ...
                    @auth
                    <a href="{{ route('checkout') }}" id="checkoutBtn" class="block w-full bg-gray-300 text-gray-500 font-display font-bold uppercase tracking-wider py-3.5 text-center cursor-not-allowed transition-colors duration-300 pointer-events-none">
                        Checkout (0)
                    </a>
                    @else
                    <a href="{{ route('login') }}" class="block w-full bg-brand-black text-white font-display font-bold uppercase tracking-wider py-3.5 text-center hover:bg-brand-orange transition-colors duration-300">
