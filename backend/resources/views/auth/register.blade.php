    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-12 lg:px-16 xl:px-24 relative">
            ...
            <div class="w-full max-w-md">
                ...
                <!-- Register Form -->
                <form method="POST" action="{{ route('register') }}" class="space-y-4 animate-slide-up-delay-2" id="registerForm">
                    @csrf
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="font-bold text-brand-orange hover:text-orange-700 transition ml-1">Masuk di Sini</a>
                    </p>
                </div>
