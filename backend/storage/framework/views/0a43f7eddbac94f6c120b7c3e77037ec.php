...
<head>
    ...
    <title>Login | Matterhorn Adventure Rental</title>
    ...
    <style>
        .auth-image {
            background-image: url('https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=1200&q=80');
    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-12 lg:px-16 xl:px-24 relative">
            ...
            <div class="w-full max-w-md">
                ...
                <div class="mb-8 animate-slide-up-delay">
                    <h1 class="font-display font-bold text-3xl uppercase text-brand-black mb-2">Masuk ke Akun</h1>
                    <p class="text-gray-500 text-sm">Silakan masuk dengan email dan password terdaftar.</p>
                </div>

                <!-- Info Box -->
                <?php if(session('success')): ?>
                <div class="bg-green-50 border border-green-200 text-green-700 rounded-sm px-4 py-3 mb-6 flex items-center gap-3 text-sm">
                ...
                <!-- Login Form -->
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5 animate-slide-up-delay-2" id="loginForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" name="remember" class="form-checkbox h-4 w-4 text-brand-orange rounded border-gray-300 focus:ring-brand-orange">
                            <span class="text-sm text-gray-500 group-hover:text-brand-orange transition">Ingat saya</span>
                        </label>
                        <a href="#" class="text-sm font-medium text-brand-orange hover:text-orange-700 transition">Lupa kata sandi?</a>
                    </div>
                    ...
                    <button
                        type="submit"
                        id="submitBtn"
                        class="w-full bg-brand-black text-white font-display font-bold uppercase tracking-wider py-4 rounded-sm hover:bg-brand-orange transition-colors duration-300 flex items-center justify-center gap-2 relative overflow-hidden group"
                    >
                ...
                <div class="space-y-3">
                    <button type="button" class="w-full border border-gray-300 rounded-sm py-3 flex items-center justify-center gap-3 text-sm font-medium hover:border-gray-400 hover:bg-gray-50 transition group">
                        ...
                        <span class="text-gray-600 group-hover:text-brand-black transition">Masuk dengan Google</span>
                    </button>
                    ...
                    <button type="button" class="w-full border border-gray-300 rounded-sm py-3 flex items-center justify-center gap-3 text-sm font-medium hover:border-gray-400 hover:bg-gray-50 transition group">
                        ...
                        <span class="text-gray-600 group-hover:text-brand-black transition">Masuk dengan Apple</span>
                    </button>
                </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-500">
                        Belum punya akun?
                        <a href="<?php echo e(route('register')); ?>" class="font-bold text-brand-orange hover:text-orange-700 transition ml-1">Daftar Sekarang</a>
                    </p>
                </div>

                <!-- Footer Note -->
                <p class="mt-6 text-xs text-gray-500 text-center leading-relaxed">
                    Dengan masuk, Anda menyetujui <a href="#" class="text-brand-orange hover:underline">Syarat & Ketentuan</a> dan <a href="#" class="text-brand-orange hover:underline">Kebijakan Privasi</a> Matterhorn.
                </p>
            </div>
        </div>
        ...
        <div class="hidden lg:block lg:w-1/2 auth-image relative">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-12 xl:p-16 text-white">
                <span class="bg-brand-orange text-white text-xs font-bold px-2 py-1 uppercase tracking-widest mb-4 inline-block">Adventure Ready</span>
                <h2 class="font-display font-bold text-4xl xl:text-5xl uppercase leading-none mb-3">Siap Untuk<br>Petualangan?</h2>
                <p class="text-gray-300 text-sm max-w-sm font-light leading-relaxed">Sewa peralatan outdoor premium. Dijamin steril, berkualitas, dan siap temani perjalananmu.</p>
                ...
                <div class="flex items-center gap-6 mt-8">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs text-gray-300">Alat Steril</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 border border-white/30 rounded-full flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-xs text-gray-300">Proses Cepat</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 border border-white/30 rounded-full flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-xs text-gray-300">Bergaransi</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:hidden auth-image h-48 relative -order-1">
            ...
            <div class="absolute bottom-4 left-6 text-white">
                <h2 class="font-display font-bold text-xl uppercase">Siap Bertualang?</h2>
                <p class="text-gray-300 text-xs">Sewa peralatan outdoor premium.</p>
            </div>
        </div>
...
<?php /**PATH C:\MyWork\Jurusan\WEBSITE\code\laravel\tent\resources\views/auth/login.blade.php ENDPATH**/ ?>