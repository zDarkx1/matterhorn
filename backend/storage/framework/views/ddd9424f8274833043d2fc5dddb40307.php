        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('cart')); ?>" class="text-sm font-medium text-gray-600 hover:text-brand-orange transition">← Kembali ke Keranjang</a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="bg-red-50 border border-red-200 p-5 rounded-sm">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo e(route('profile')); ?>" class="inline-flex items-center gap-2 bg-brand-black text-white font-display font-bold uppercase tracking-wider text-xs px-5 py-2.5 hover:bg-brand-orange transition-colors duration-300">
                    ...
                    <div id="addrDisplay" class="hidden">
                        <div class="border border-gray-200 p-5 relative" id="addressCard">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <a href="<?php echo e(route('profile')); ?>" class="text-xs text-brand-orange hover:text-orange-700 font-bold transition flex-shrink-0 border border-brand-orange px-3 py-1.5 hover:bg-brand-orange hover:text-white">Ubah</a>
                            </div>
                        </div>
            ...
            <div class="w-full lg:w-[400px] lg:flex-shrink-0 space-y-4">
                ...
                <div class="bg-white border border-gray-200 p-6 sticky top-24 fade-in" style="animation-delay: 0.15s">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <a href="<?php echo e(route('cart')); ?>" class="text-xs text-gray-500 hover:text-brand-orange border border-gray-300 px-3 py-1 font-medium transition">Ubah</a>
                    </div>
                ...
                if (checkoutItems.length === 0) {
                    container.innerHTML = `
                        <div class="text-center py-6">
                            ...
                            <a href="${'<?php echo e(route("cart")); ?>'}" class="text-brand-orange text-sm font-bold hover:text-orange-700">Kembali ke Keranjang</a>
                        </div>`;
                    return;
                }
...
<?php /**PATH C:\MyWork\Jurusan\WEBSITE\code\laravel\tent\resources\views/checkout.blade.php ENDPATH**/ ?>