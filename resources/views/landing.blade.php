...
<body class="bg-white text-brand-black antialiased font-sans">
                            ...
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    ...
                                    <a href="#" class="group/item flex items-center gap-2 hover:bg-gray-50 p-2 rounded transition-all">
                                        ...
                                        <span class="text-sm font-medium uppercase text-gray-600 group-hover/item:text-brand-black tracking-wide">{{ $category }}</span>
                                    </a>
                                    @empty
                ...
                <div class="flex items-center gap-4">
                    ...
                    @auth
                        <div class="hidden md:flex items-center gap-3">
                            <a href="{{ route('profile') }}" class="text-sm text-gray-600 hover:text-brand-orange transition">Halo, <strong class="text-brand-black">{{ Auth::user()->name }}</strong></a>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="hidden md:flex items-center gap-2 p-2 hover:text-brand-orange transition font-display font-medium uppercase text-sm border border-gray-300 px-4 py-2 hover:border-brand-orange">
                            Login
                        </a>
                    @endauth
                </div>
            ...
            <div class="bg-brand-black text-white p-4 flex justify-between items-center select-none flex-shrink-0">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('images/matterhorn.png') }}" alt="M" class="w-5 h-5 object-contain">
                    </div>
                    <div>
            ...
            function appendMessage(role, text) {
                ...
                `;
                    ...
                    <div class="w-6 h-6 bg-white border border-gray-200 rounded-full flex-shrink-0 flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('images/matterhorn.png') }}" class="w-4 h-4 object-contain">
                    </div>
    ...
    <aside id="cartDrawer" class="fixed top-0 right-0 h-full w-full max-w-md bg-white z-[60] shadow-2xl transform translate-x-full transition-transform duration-300 flex flex-col" role="dialog" aria-label="Keranjang Belanja" aria-hidden="true">
        ...
        <div id="cartFooter" class="hidden border-t border-gray-200 px-6 py-4">
            ...
            <button class="w-full bg-brand-black text-white font-display font-bold uppercase tracking-wider py-3.5 hover:bg-brand-orange transition-colors duration-300" disabled>
