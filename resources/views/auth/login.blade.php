    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-12 lg:px-16 xl:px-24 relative">
            ...
            <div class="w-full max-w-md">
                ...
                <!-- Login Form -->
                <form method="POST" action="{{ route('login') }}" class="space-y-5 animate-slide-up-delay-2" id="loginForm">
                    @csrf
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-500">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-bold text-brand-orange hover:text-orange-700 transition ml-1">Daftar Sekarang</a>
                    </p>
                </div>
